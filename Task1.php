<!-- Задача №1: сформировать массив с 
данными для блока «Опыт работы». 
Вывести данные массива в HTML-шаблоне. -->

<?php
    $name = 'Илья';
    $profession = 'Мед.брат-анестезист';
    $city = 'Вологда, Россия';
    $e_mail = 'Nebmes@mail.ru';
    $phone = '+79114412344';
    $skills = [Photoshop, Illustrator, Corel, Micromine];
    $percent = [30, 20, 30, 40];
    $age = 2022-1987;
    $work =[Мед.брат-анестезист, студент];
    $experience = ['работаю давно, перегорел', 'работал во время учёбы'];
    $date = ['14.08.2007', 'настоящее время', '1.09.2005','25.06.2008'];
?>
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $percent[1]; ?>%">
              <div class="w3-center w3-text-white"><?php echo $percent[1]; ?>%</div>
            </div>
          </div>
          <p><?php echo $skills[2]; ?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $percent[2]; ?>%"><?php echo $percent[2]; ?>%</div>
          </div>
